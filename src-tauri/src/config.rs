...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            ...
            database_url: "postgresql://neondb_owner:npg_bxlnSc2N3vZO@ep-super-sound-ahwuqcgc-pooler.c-3.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require",
            firebase_project_id: "mealpro-development",
        }
    }
}
